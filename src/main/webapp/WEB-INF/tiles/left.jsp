...
<div id="aside">
	...
	<div id="aside-notice">
		...
		<hr>
		<!-- 바로가기 링크 -->
		<a href="/hobby/" class="aside-link_menu">┗ 공지사항</a>
		<!-- 공지사항 게시판 이동 -->
	</div>
	<!-- 카테고리별 영역 -->
	<!-- e-스포츠 영역 -->
	<div id="aside-esport">
		...
		<hr>
		<a href="/hobby/" class="aside-link_menu">┗ 팀원모집</a>
		<!-- e-스포츠 팀원모집 게시판 이동 -->
		<a href="/hobby/" class="aside-link_menu">┗ 팁과 노하우</a>
		<!-- e-스포츠 팁과노하우 게시판 이동 -->
		<a href="/hobby/" class="aside-link_menu">┗ 질문과 답변</a>
		<!-- e-스포츠 질문과답변 게시판 이동 -->
		<a href="/hobby/" class="aside-link_menu">┗ 자유게시판</a>
		<!-- e-스포츠 자유게시판 게시판 이동 -->
	</div>
	<!-- 스포츠 영역 -->
	<div id="aside-sport">
