...
<div id="sr_main">
	...
	<div id="sr_search">
		<form action="/hobby/" method="">
			...
			</select> <input type="text" class="sr_input_text" maxlength="50"
				name="sr_txtContent"> <input type="submit"
				class="sr_input_button" value="검색">
		</form>
		<!-- form 태그 끝 -->
	</div>
	<!-- 페이지 내 검색 끝 -->
...
--%>
			<div class="sr_list_content">
				<span class="sr_span_title"><a href="">제목1 </a></span>
				<!-- 제목 -->
				<span class="sr_span_content">이성훈♡하지훈 </span>
				<!-- 내용 -->
				<div class="sr_list_content_">
					<span><a href="">경로</a></span> <span>작성일자</span>
				</div>
			</div>
			<div class="sr_list_content">
				<span><a href="">제목2</a></span> <span>윤찬호♡이석운</span>
				<div class="sr_list_content_">
					<span><a href="">경로</a></span> <span>작성일자</span>
				</div>
			</div>
			<div class="sr_list_content">
				<span><a href="">제목3</a></span> <span>김정태♡한승채</span>
				<div class="sr_list_content_">
					<span><a href="">경로</a></span> <span>작성일자</span>
				</div>
			</div>
