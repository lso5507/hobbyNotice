...
<link href="<%=path%>/resources/css/board_detailview.css"
	...
	<div class="board_detail">
		...
		<div class="comment_view">
			<c:forEach items="${comments}" var="comment">
				<tr>
					<td>이름 : ${comment.comm_name} 날짜 :<fmt:formatDate
							pattern="yyyy-MM-dd-hh:mm" value="${comment.comm_regDate}" /></td>
					<br>
			...
			<form action="board_comment">
				댓글 : <input type="text" name="comm_content"> <input
					type="hidden" value=${param.cnt } name="dno">
				<!--파라미터 값을 value로 넘겨줌  -->
